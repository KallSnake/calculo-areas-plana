...
namespace CalcularFiguraPlanas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Losango calLosango = new Losango();

            Console.Write("Informe o valor da diagonal maior do losango em metros: ");
            string dmr = Console.ReadLine();

            Console.WriteLine();

            Console.Write("Informe o valor da diagonal menor do losango em metros: ");
            string dmn = Console.ReadLine();

            Console.WriteLine();

            double value6 = calLosango.AreaLosango(Convert.ToDouble(dmr), Convert.ToDouble(dmn));

            Console.WriteLine();

            Console.WriteLine("Área do losango é de: " + value6 + " m*2");
